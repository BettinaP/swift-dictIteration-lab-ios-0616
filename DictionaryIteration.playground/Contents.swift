...
// write your code here
            ...
            if let album = bandAlbums[bandName] {

            print("\(bandName)'s top-selling albumw as \(album)")
 ...
 */
            //use dictionary that maps Int to string.
...
var highSchoolExamResults = ["Grade 9": "B",
                             "Grade 10" : "A",
                             "Grade 11" : "C",
                             "Grade 12" : "B"
 ...
 */
// write your code here
for ( grade, score) in highSchoolExamResults {
...
for ( grade, score) in highSchoolExamResults {
    ...
    if let highestScore = highSchoolExamResults[bestGrade] {
...
if let bestScore = highSchoolExamResults[bestGrade] {
        print("\(bestGrade) got the highest score with \(bestScore)!")
}
